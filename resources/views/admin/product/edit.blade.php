                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 col-xs-12">
                        ...
                        <div class="col-xs-4 col-sm-4" style="padding: 0px">
                            <img id="blah" src="{{ old('b64') ? old('b64'): $image}}" class="img-responsive img-radio" style="width: 160px; height: 150px">
                        </div>
                    ...
                    <div class="form-group col-sm-12 col-xs-12" >
                        <div style="float: right;">
                            ...
                            <button type="submit"  class="btn btn-primary" id="submit">@lang('sample.update')</button>
                        </div>
                    </div>
                </div>
            </form>
